...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '蒲小帅', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '时光是画在娟上的河流🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.puxiaoshuai.top', // 网站地址
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    ...
    
    {
      ...
      url: 'https://music.163.com/song/media/outer/url?id=1985398580.mp3',
      cover:
        'https://p2.music.126.net/jZtaAXRc4dQjpJFoLac6lw==/109951167917549319.jpg?param=130y130'
    }
  ],
